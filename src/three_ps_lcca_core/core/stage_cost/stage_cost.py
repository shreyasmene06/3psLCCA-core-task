...
class StageCostCalculator:
    ...
    # Road user and vehicular emission cost helper
    ...
    # Construction costs and associated emissions
    ...
    # Use stage routine inspection costs
    ...
    # Use stage periodic maintenance and carbon costs
    ...
    # Use stage major inspection costs
    ...
    # Use stage major repair cost breakdown
    ...
    # Use stage replacement costs for bearing and expansion joint
    ...
    # End-of-life demolition and disposal costs
    ...
    # Initial stage cost aggregation
